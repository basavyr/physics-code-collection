...
# gs = fig.add_gridspec(3, 2, hspace=0.13, wspace=0.1)
...
ax[1, 0].set_title(r'$A_2<A_1<A_3$')
im4 = ax[1, 1].contourf(X, Y, Z_231,  levels=21, antialiased=True)
ax[1, 1].set_title(r'$A_2<A_3<A_1$')
im5 = ax[2, 0].contourf(X, Y, Z_312,  levels=21, antialiased=True)
ax[2, 0].set_title(r'$A_3<A_1<A_2$')
ax[2, 0].set(xlabel=r'$\varphi$ $[^\circ]$', ylabel=r'$\psi$ $[^\circ]$')
im6 = ax[2, 1].contourf(X, Y, Z_321,  levels=21, antialiased=True)
ax[2, 1].set_title(r'$A_3<A_2<A_1$')

imgs = [im1, im2, im3, im4, im5, im6]
axis_list = [ax[0, 0], ax[0, 1], ax[1, 0], ax[1, 1], ax[2, 0], ax[2, 1]]
